    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       <li>
        ...
        <li><a href="../PageUnicoin/NewOrder.html"><i class="fa fa-shopping-cart"></i> <span>Orders</span></a></li>
        <li class="treeview">
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
            ...
            Meanwhile, you may <a href="../unicoin-mining.html">return to dashboard</a> or try using the search form.
          </p>
        </div>
        <!-- /.error-content -->
      </div>
