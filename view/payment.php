    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="col-sm-12">
          ...
          <p>Saya (selaku sebagai <strong>"pelanggan"</strong>) sepakat dengan syarat dan kondisi kontrak (<strong>"perjanjian"</strong>) ini tertanggal <?php echo $_SESSION['orderCreated'];?> antara:<br>
