        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            foreach ($ordershistorylist as $orderhistoryitem) {
              ...
              <tr>
                <td><?php echo $orderhistoryitem['orderCreated']; $_SESSION['orderCreated']=$orderhistoryitem['orderCreated']; ?></td>
                <td><?php echo $orderhistoryitem['name']?></td>
                <td><?php echo $orderhistoryitem['hashPower']?></td>
                <td><a href="#" data-toggle="modal" data-target="#exampleModal<?php echo $orderhistoryitem['id'];?>">Lifetime</a>
                  <div class="modal fade" id="exampleModal<?php echo $orderhistoryitem['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col-sm-12">
                              ...
                              <p>Saya (selaku sebagai <strong>"pelanggan"</strong>) sepakat dengan syarat dan kondisi kontrak (<strong>"perjanjian"</strong>) ini tertanggal <?php echo $orderhistoryitem['orderCreated'];?> antara:<br>
                              ...
                              <p>
                                                                                          ...
                                                                                          <span style="display:inline-block;width:150px;">Tanggal Mulai:</span><?php echo $orderhistoryitem['contractStart'];?><br>
                                                                                          <span style="display:inline-block;width:150px;">Tenaga menambang:</span><?php echo $orderhistoryitem['hashPower'];?>
                                                                                      </p>
                          ...
                          Pelanggan mengetahui akan resiko aset digital (contoh penurunan nilai tukar aset digital ke mata uang tertentu [contoh rupiah]).</p>
                                ...
                                <p>
                                  Batas minimum penarikan bitcoin sebesar <strong>0.001 bitcoin (BTC)</strong>.
