...
$target_dir="/home/classhos/shop.unicoin-mining.com/public/";
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["imageconfirm"]["tmp_name"], $target_dir."uploads/".$_SESSION['orderid']."_".basename($_FILES["imageconfirm"]["name"]))) {
      $urlconfirm="https://shop.unicoin-mining.com/uploads/".$_SESSION['orderid']."_".basename($_FILES["imageconfirm"]["name"]);
